...
if ($page === 'y') { ?>
    ...
    <div class="d-flex justify-content-center">
        <label for="" style="width: 100px;">ผู้ที่ต้องการยืม : </label>
        <input type="text" class="form-control mx-3" id="inName" style="width:500px" placeholder="กรอกชื่อผู้ใช้">
        <button class="btn btn-success" id="btnName">ตกลง</button>
    </div>


    <div class="d-flex justify-content-center mt-3">
        <label for="" style="width: 100px;">รหัสหนังสือ : </label>
        <input type="text" class="form-control mx-3" id="inBook" style="width:500px" placeholder="กรอกรหัสหนังสือ">
